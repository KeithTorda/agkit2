...
URL_CHECKS = (
    CheckSpec("Lighthouse Audit", "skills/performance-profiling/scripts/lighthouse_audit.py", "P6 Runtime Checks", target="url", timeout=180),
    CheckSpec("Playwright Smoke Test", "skills/testing-patterns/scripts/playwright_runner.py", "P6 Runtime Checks", target="url", timeout=120),
)
