...
Usage:
    python C:/Users/Keith/.gemini/config/plugins/ag-kit-v2/scripts/session_manager.py status [path]
    python C:/Users/Keith/.gemini/config/plugins/ag-kit-v2/scripts/session_manager.py info [path]
"""
