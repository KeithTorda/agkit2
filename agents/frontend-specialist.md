...
7. Look, critique, refine: render, apply frontend-design §4.0 as questions, fix, render again (browser-verification §2b).
8. Gates: `python C:/Users/Keith/.gemini/config/plugins/ag-kit-v2/scripts/checklist.py .`; `/see`; report evidence.
...
5. Verify — re-render at 390 / 768 / 1440; `/see` report with before/after; remove any CSS the fix made dead; record a durable cause as `[failure]` (memory-system).
