...
class PerformanceChecker:
                ...
                if 'useEffect' in content:
                    if re.search(r'useEffect.*?fetch\(', content, re.DOTALL):
                        self.warnings.append({
                            ...
                            'fix': 'Move the fetch to a Server Component or use TanStack Query for deduplication',
    ...
    def run(self):
        ...
        # check_missing_memoization removed: with the React Compiler, manual memo is the exception, not the rule.
