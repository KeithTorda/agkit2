# DESIGN.md reference collection

Curated from [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md). Each entry is a published DESIGN.md with a one-line vibe summary; pick the 1-2 closest to the brief and fetch them only when a fetch or browsing tool is available (see [SKILL.md](./SKILL.md)).
